...
public class add_librarian extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
			...
			if(e.getSource()==b1)
		{
			...
			String s1 = "insert into add_librarian values('"+tf1.getText()+"','"+tf2.getText()+"','"+tf3.getText()+"','"+tf4.getText()+"',"+tf5.getText()+",'"+tf6.getText()+"')";
